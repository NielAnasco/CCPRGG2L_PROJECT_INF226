...
public class GamePanel extends JPanel implements Runnable {
    ...
    public static String gameBackgroundImage;

    // Set score limit
    private final int scoreLimit = 2;
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("Player 1: " + player1, 100, g.getFont().getSize());        
        g.drawString("Player 2: " + player2,650, g.getFont().getSize()); 
